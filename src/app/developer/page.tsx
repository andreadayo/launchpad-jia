        ...
        >
          ...
          <div className="developer-section">
            <div className="developer-section-left">
              ...
              />
              <p>
                Established in 2014, White Cloak Technologies Inc. has grown to be a trusted pillar
                in software development from the heart of the Philippines. As a preferred innovation
                partner, we've collaborated with prominent corporations, converting challenges into
                success stories through adept technology applications.
                <br />
                <br />
                Beyond Jia, White Cloak has also developed other AI-powered applications, including{" "}
                <a href="https://splurge.art" target="_blank" rel="noopener noreferrer">
                  Splurge Art
                </a>
                , an AI art generator, and{" "}
                <a href="https://www.hellopixie.ai/" target="_blank" rel="noopener noreferrer">
                  Pixie
                </a>
