...
const testimonials = [
  {
    quote:
      "I liked that it was formal - like a real-life interview - but still natural and conversational!",
  },
  {
...
export default function HomePage() {
  ...
  const { elementRef: imagesContainerRef, isVisible: isImagesContainerVisible } = useLazyLoad({
    delay: 600,
  });
  const { elementRef: featureListRef, isVisible: isFeatureListVisible } = useLazyLoad({
    delay: 0,
    stagger: true,
    staggerDelay: 200,
  });
  ...
  const { elementRef: strengthsCalendarIconRef, isVisible: isStrengthsCalendarIconVisible } =
    useLazyLoad({ delay: 400 });
  const { elementRef: strengthsClockIconRef, isVisible: isStrengthsClockIconVisible } = useLazyLoad(
    { delay: 400 }
  );
  const { elementRef: strengthsTrophyIconRef, isVisible: isStrengthsTrophyIconVisible } =
    useLazyLoad({ delay: 600 });
  const {
    elementRef: strengthsMagnifyingGlassIconRef,
    isVisible: isStrengthsMagnifyingGlassIconVisible,
  } = useLazyLoad({ delay: 600 });
  ...
  const { elementRef: firstStepLineRef, isVisible: isFirstStepLineVisible } = useLazyLoad({
    delay: 400,
  });
  const { elementRef: firstStepGuideTextRef, isVisible: isFirstStepGuideTextVisible } = useLazyLoad(
    { delay: 600 }
  );
  const { elementRef: secondStepRef, isVisible: isSecondStepVisible } = useLazyLoad({ delay: 400 });
  const { elementRef: secondStepLineRef, isVisible: isSecondStepLineVisible } = useLazyLoad({
    delay: 400,
  });
  const { elementRef: secondStepGuideTextRef, isVisible: isSecondStepGuideTextVisible } =
    useLazyLoad({ delay: 600 });
  const { elementRef: thirdStepRef, isVisible: isThirdStepVisible } = useLazyLoad({ delay: 400 });
  const { elementRef: thirdStepLineRef, isVisible: isThirdStepLineVisible } = useLazyLoad({
    delay: 400,
  });
  const { elementRef: thirdStepGuideTextRef, isVisible: isThirdStepGuideTextVisible } = useLazyLoad(
    { delay: 600 }
  );
  const { elementRef: fourthStepRef, isVisible: isFourthStepVisible } = useLazyLoad({ delay: 400 });
  const { elementRef: fourthStepLineRef, isVisible: isFourthStepLineVisible } = useLazyLoad({
    delay: 400,
  });
  const { elementRef: fourthStepGuideTextRef, isVisible: isFourthStepGuideTextVisible } =
    useLazyLoad({ delay: 600 });
  const { elementRef: fifthStepRef, isVisible: isFifthStepVisible } = useLazyLoad({ delay: 400 });
  const { elementRef: fifthStepLineRef, isVisible: isFifthStepLineVisible } = useLazyLoad({
    delay: 400,
  });
  const { elementRef: fifthStepGuideTextRef, isVisible: isFifthStepGuideTextVisible } = useLazyLoad(
    { delay: 600 }
  );
    ...
    if (testimonialsContainerRef.current) {
      ...
      if (nextCard) {
        nextCard.scrollIntoView({
          behavior: "smooth",
          inline:
            index === testimonialsContainerRef.current.children?.length - 1 ? "nearest" : "center",
          block: "nearest",
        });
      }
    }
    ...
    const handleScroll = () => {
      ...
      let scrollLeft = Math.abs(
        firstChild.getBoundingClientRect().left -
          testimonialsContainerRef.current.getBoundingClientRect().left
      );
      ...
      <main className="homepage-main">
        <div ref={ref}>
                ...
                <div className="about-us-section">
                  ...
                  >
                    <h2 className="subheader-2">
                      Modernize your hiring process <br /> with cutting-edge AI
                    </h2>
                  </div>
                  ...
                  >
                    <h1 className="subheader">
                      Jia is an end-to-end hiring tool for recruiters that combines:
                    </h1>
                    <div className="feature-list">
                      ...
                      >
                        <i
                          ...
                          style={{ fontSize: 24, color: "#9525C9" }}
                        ></i>
                        <span>
                          AI Interviewer with <br />
                          Smart Analysis and Scoring
                        </span>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        ...
                        ></i>
                        <span>
                          Modern Application <br /> Tracking System (ATS)
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          >
            ...
            >
              <h1 className="header">
                Modernize your hiring process with <br /> cutting-edge AI
              </h1>
              ...
              >
                ...
                <div
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(196, 185, 252, 0.5) 0%, rgba(176, 228, 240, 0.5) 100%)",
                ...
                >
                  ...
                  >
                    Cut screening time from weeks to days. Jia screens CVs simultaneously and
                    conducts AI interviews anytime, eliminating back-and-forth scheduling.
                  </p>
                  <div
                    ref={strengthsCalendarIconRef}
                    style={{
                      opacity: isStrengthsCalendarIconVisible ? 1 : 0,
                      transform: isStrengthsCalendarIconVisible
                        ? "translateY(0)"
                        : "translateY(30px)",
                      transition:
                  ...
                  >
                    <Image src="/calendar.svg" alt="Value Proposition 1" width={110} height={110} />
                  </div>
                </div>
                {/* Value Proposition 2 */}
                <div
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(214, 213, 255, 0.5) 0%, rgba(255, 228, 228, 0.5) 100%)",
                    boxShadow: palette.cardShadow,
                    borderRadius: 20,
                    padding: "20px 40px",
                    minHeight: 270,
                ...
                >
                  ...
                  >
                    Automate interviews and free your team to focus on top candidates, allowing you
                    to scale hiring without scaling your recruitment team.
                  </p>
                  <div
                    ref={strengthsClockIconRef}
                    style={{
                  ...
                  >
                    <Image src="/clock.svg" alt="Value Proposition 1" width={110} height={110} />
                  </div>
                </div>
                {/* Value Proposition 3 */}
                <div
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(255, 228, 228, 0.5) 0%, rgba(214, 213, 255, 0.5) 100%)",
                    boxShadow: palette.cardShadow,
                    borderRadius: 20,
                    padding: "20px 40px",
                    minHeight: 270,
                ...
                >
                  ...
                  >
                    Ensure fair, consistent evaluations with standardized AI questions and objective
                    scoring for every candidate.
                  </p>
                  <div
                    ref={strengthsMagnifyingGlassIconRef}
                    style={{
                      opacity: isStrengthsMagnifyingGlassIconVisible ? 1 : 0,
                      transform: isStrengthsMagnifyingGlassIconVisible
                        ? "translateY(0)"
                        : "translateY(30px)",
                      transition:
                        "opacity 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",
                ...
                <div
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(176, 228, 240, 0.5) 0%, rgba(196, 185, 252, 0.5) 100%)",
                    boxShadow: palette.cardShadow,
                    borderRadius: 20,
                    padding: "20px 40px",
                    minHeight: 270,
                ...
                >
                  ...
                  >
                    Get AI-powered interview transcripts, job-fit scores, and insights on technical
                    and soft skills to make confident, data-driven hiring choices.
                  </p>
                  <div
                    ref={strengthsTrophyIconRef}
                    style={{
                      opacity: isStrengthsTrophyIconVisible ? 1 : 0,
                      transform: isStrengthsTrophyIconVisible
                        ? "translateY(0)"
                        : "translateY(30px)",
                      transition:
                        "opacity 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",
                  ...
                  >
                    <Image src="/trophy.svg" alt="Value Proposition 1" width={110} height={110} />
                  </div>
                </div>
              </div>
              <div
              ...
              <div className="steps-container">
                <div className="step">
                  ...
                  <div>
                    ...
                    <div
                      ref={firstStepGuideTextRef}
                      style={{
                        opacity: isFirstStepGuideTextVisible ? 1 : 0,
                        transform: isFirstStepGuideTextVisible
                          ? "translateY(0)"
                          : "translateY(30px)",
                        transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
                      }}
                    >
                      <p>
                        Set up your job post with requirements and details. While waiting for
                        applications, generate AI-powered interview questions in advance.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="step">
                  ...
                  <div>
                    ...
                    <div
                      ref={secondStepGuideTextRef}
                      style={{
                        opacity: isSecondStepGuideTextVisible ? 1 : 0,
                        transform: isSecondStepGuideTextVisible
                          ? "translateY(0)"
                          : "translateY(30px)",
                        transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
                      }}
                    >
                      <p>
                        Jia reviews CVs using AI, automatically moving good-fit candidates to the
                        next step.
                        <br />
                        <br />
                        For those below good-fit, recruiters can review candidates whether to
                        endorse or drop. For bad-fit candidates, they are automatically dropped.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="step">
                  ...
                  <div>
                    ...
                    <div
                      ref={thirdStepGuideTextRef}
                      style={{
                        opacity: isThirdStepGuideTextVisible ? 1 : 0,
                        transform: isThirdStepGuideTextVisible
                          ? "translateY(0)"
                          : "translateY(30px)",
                        transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
                      }}
                    >
                      <p>
                        Candidates complete structured, skills-based AI interviews anytime,
                        anywhere.
                      </p>
                    </div>
                  </div>
                ...
                <div className="step">
                  ...
                  <div>
                    ...
                    <div
                      ref={fourthStepGuideTextRef}
                      style={{
                        opacity: isFourthStepGuideTextVisible ? 1 : 0,
                        transform: isFourthStepGuideTextVisible
                          ? "translateY(0)"
                          : "translateY(30px)",
                        transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
                      }}
                    >
                      <p>
                        Access job-fit scores, strengths, and clear recommendations to identify top
                        candidates.
                      </p>
                    </div>
                  </div>
                ...
                <div className="step">
                  ...
                  <div>
                    ...
                    <div
                      ref={fifthStepGuideTextRef}
                      style={{
                        opacity: isFifthStepGuideTextVisible ? 1 : 0,
                        transform: isFifthStepGuideTextVisible
                          ? "translateY(0)"
                          : "translateY(30px)",
                        transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
                      }}
                    >
                      <p>
                        Move qualified candidates to your final interviews, allowing your team to
                        double-check and confidently decide on the best hire.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          >
            <section id="testimonials" className="testimonials-section">
              ...
              >
                <div className="testimonial-header">
                  <h1 className="header">
                    What candidates are <br /> saying about Jia
                  </h1>
                </div>
                <Image
                  src="/sphere.png"
                ...
                >
                  ...
                  >
                    <i
                      className="la la-arrow-circle-left"
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      display:
                        currentTestimonialIndex === testimonials.length - 1 ? "none" : "block",
                    }}
                    onClick={() => {
            ...
            <section id="newsletter" className="newsletter-section">
              ...
              <div className="newsletter-container">
                ...
                <p>
                  Get the latest updates on Jia and more Exclusive behind-the- <br /> scenes look on
                  our production.
                </p>
