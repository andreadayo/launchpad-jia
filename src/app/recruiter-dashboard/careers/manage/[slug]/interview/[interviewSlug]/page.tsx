          ...
          <div className="col">
            {loadingRecording ? (
              ...
              <div className="card" style={{ marginBottom: "16px" }}>
                <div className="card-header">
                  <h3 className="mb-0 mr-auto">
                    <i className="la la-microphone text-primary mr-2" /> Interview Recording
                  </h3>
                </div>
                <div className="card-body">
                  <span>
                    <i className="la la-microphone-slash" /> No Recording Available
                  </span>
                </div>
              </div>
            )}
                      ...
                      transcripts.map((msg, idx) => {
                        return (
                          <React.Fragment key={idx}>
                            <li
                              key={idx}
                              className={`fade-in-bottom ${msg.type === "user" ? "user" : "bot"}`}
                            >
                              <strong>
                                {msg.type === "user"
                            ...
                            <div className="tr-time mt--2 mb-3 fade-in-bottom">
                              <small>
                                ...
                                <i className="la la-clock" /> {moment(msg.time).format("hh:mm A")}
                              </small>
