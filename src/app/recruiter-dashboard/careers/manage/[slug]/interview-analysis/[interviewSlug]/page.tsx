  ...
  useEffect(() => {
    async function fetchFeedback() {
      ...
      try {
        ...
        const fb = res.data.find((item) => item.interviewID === interview.interviewID);
        setFeedback(fb || null);
      } catch (err) {
        setFeedback(null);
      }
    ...
    <>
      ...
      <div style={{ padding: "16px 20px" }}>
        ...
        {interview?.retakeRequest &&
          !["Approved", "Rejected"].includes(interview?.retakeRequest?.status) && (
                  ...
                  {isGeneratingAnalysis ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <div
                          style={{ display: "flex", flexDirection: "column", gap: 8, width: "70%" }}
                        >
                              ...
                              >
                                ...
                                >
                                  <i
                                    ...
                                    style={{ fontSize: 16, marginRight: "5px", color: "#6941C6" }}
                                  ></i>
                        ...
                        return (
                          <React.Fragment key={idx}>
                            ...
                            >
                              ...
                              <small>{moment(msg.time).format("hh:mm A")}</small>
                              <div
                                style={{
                                  width: "1px",
                                  height: "20px",
            ...
            <div className="layered-card-outer">
              <div className="layered-card-middle">
                ...
                >
                  ...
                  >
                    <i
                      className={`la la-${interviewRecording?.filetype.includes("audio") ? "microphone" : "video"}`}
                      style={{ color: "#FFFFFF", fontSize: 20 }}
                    ></i>
                  </div>
                  <span style={{ fontSize: 16, color: "#181D27", fontWeight: 700 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    >
                      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        ...
                        <span style={{ fontSize: "12px", color: "#6B7280" }}>
                          {transcripts?.[0]?.time
                            ? new Date(transcripts?.[0]?.time).toLocaleDateString("en-US", {
                                month: "short",
                                day: "numeric",
                                year: "numeric",
                              })
            ...
            <div className="layered-card-outer">
              <div className="layered-card-middle">
                ...
                <div className="layered-card-content">
                  <button
                    disabled={
                      isGeneratingAnalysis || isGeneratingSummary || transcripts.length === 0
                    }
                    onClick={() => {
                      regenInsights();
                    }}
                  ...
                  <span style={{ fontSize: "14px", color: "#717680", textAlign: "center" }}>
                    Trigger the button below to delete the interview transcript and set the status
                    to "For Interview".
                  </span>
                  <button
                    onClick={() => {
              ...
              <div className="layered-card-outer">
                <div className="layered-card-middle">
                  ...
                  <div className="layered-card-content">
                    ...
                    {feedback?.feedback && (
                      <span style={{ fontSize: "14px", color: "black", textAlign: "left" }}>
                        "{feedback?.feedback}"
                      </span>
                    )}
                  </div>
        ...
        {showCandidateModal && (
          <CandidateModal candidate={interview} setShowCandidateModal={setShowCandidateModal} />
        )}
