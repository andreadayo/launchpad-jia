            ...
            <div className="col-lg-6 col-7">
              <nav aria-label="breadcrumb" className="d-none d-md-inline-block">
                <ol
                  ...
                  style={{ backgroundColor: "transparent", padding: 0, marginBottom: 0 }}
                >
                  <div
                    style={{
                      display: "flex",
              ...
              >
                ...
                {user && (
                  ...
                  >
                    ...
                    >
                      <span style={{ fontWeight: 700, fontSize: 14, color: "#414651" }}>
                        {user?.name}
                      </span>
                      <span
                        style={{
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, fontSize: 14, color: "#717680" }}>
                      {user?.email}
                    </span>
                  </div>
                </div>
