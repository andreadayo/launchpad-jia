...
export default function Footer({ isVisible }: { isVisible: boolean }) {
  return (
    <footer className="home-footer" style={{ zIndex: isVisible ? 1 : 3 }}>
        ...
        <div className="footer-column">
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              >
                Sales Team:{" "}
                <a href="mailto:inquire@hellojia.ai" target="_blank" rel="noopener noreferrer">
                  inquire@hellojia.ai
                </a>
              </div>
              ...
              >
                Development Team:{" "}
                <a href="mailto:hello@whitecloak.com" target="_blank" rel="noopener noreferrer">
