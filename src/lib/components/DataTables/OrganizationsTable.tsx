      ...
      >
        <div>
          ...
          <span style={{ fontSize: "16px", color: "#717680", fontWeight: 500 }}>
            View all organizations listed under Jia.
          </span>
        </div>
                        ...
                        <tr key={organization._id}>
                          <td>
                            ...
                            >
                              ...
                              />
                              <div style={{ fontSize: 14, color: "#181D27", fontWeight: 700 }}>
                                {organization.name}
                              </div>
                            </div>
                          </td>
                          ...
                          <td>
                            ...
                            >
                              ...
                              >
                                <div
                                  style={{
                                    width: `${organization.activeJobs >= organization.jobLimit ? 100 : (organization.activeJobs / organization.jobLimit) * 100}%`,
                                    height: 8,
                                    borderRadius: 10,
                                    background: "#FCCEC0",
                                  }}
                              ...
                              {menuOpen && selectedOrganization?._id === organization._id && (
                                ...
                                >
                                  ...
                                  <div
                                    ...
                                    style={{
                                      color:
                                        organization.status === "active" ? "#B42318" : "#027948",
                                    }}
                                    onClick={(e) => {
                                      if (e.defaultPrevented) return;
                                      e.preventDefault();
