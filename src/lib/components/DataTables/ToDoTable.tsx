      ...
      try {
        if (initialLoadRef.current) {
          ...
          const uniquePositions = [
            ...new Set(response.data.map((candidate: any) => candidate.jobTitle)),
          ];
          setPositionOptions([
            { name: "All Careers" },
    ...
    <>
      ...
      >
        ...
        >
          {taskType !== "retake-interview-requests" && (
            <CustomDropdown2
              screeningSetting={filterPosition}
              onSelectSetting={setFilterPosition}
              settingList={positionOptions}
      ...
      {showConfirmationModal && (
        <ConfirmationModal action={showConfirmationModal} onAction={handleCandidateAction} />
      )}
