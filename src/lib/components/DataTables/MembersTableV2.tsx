...
export default function MembersV2Table() {
  ...
  return (
    <div className="row" style={{ marginBottom: "50px" }}>
        ...
        <div className="card shadow-none">
          ...
          <div className="card-header border-0 justify-content-between">
            ...
            <button
              ...
              style={{ backgroundColor: "#6941C6", fontSize: "14px", fontWeight: 550 }}
              ...
              <table className="table align-items-center table-flush">
                <thead className="thead-light">
                  <tr>
                    ...
                    <th scope="col" className="sort" data-sort="role">
                      Role
                    </th>
                    ...
                    members.map((member) => (
                      <tr key={member._id}>
                        ...
                        <td>
                          <span
                            className={`badge ${
                              member.status === "joined" ? "badge-success" : "badge-secondary"
                            }`}
                            style={{
                              textTransform: "capitalize",
                              borderRadius: "60px",
      ...
      {showInviteModal && <InviteMemberMenu onClose={() => setShowInviteModal(false)} />}
    ...
    >
      ...
      <div className="modal-body">
        ...
        <div style={{ marginTop: 16, display: "flex", justifyContent: "flex-end" }}>
          <button
            className="button-primary"
            disabled={!role || (role === "hiring_manager" && selectedCareers.length === 0)}
            onClick={handleOnSubmit}
          >
            Update
          </button>
