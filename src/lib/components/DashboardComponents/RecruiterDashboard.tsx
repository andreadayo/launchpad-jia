    ...
    <div className="recruiter-dashboard-container">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 0, margin: "20px 0" }}>
        ...
        <span style={{ fontSize: "16px", color: "#717680", fontWeight: 500 }}>
          These items require your decision.
        </span>
      </div>
            ...
            <div className="pending-recruiter-task-table">
              ...
              {pendingCVReview.slice(0, 10).map((candidate, index) => (
                <div
                  ...
                  style={{
                    borderBottom:
                      index === pendingCVReview.slice(0, 10).length - 1
                        ? "none"
                        : "1px solid #E0E0E0",
                  }}
                >
                  <div style={{ display: "flex", flexDirection: "row", gap: 8 }}>
                    <img
                      src={candidate?.image}
                      alt={candidate?.name}
                      style={{ width: 40, height: 40, borderRadius: "50%", background: "#E0E0E0" }}
                    />
                    <div>
                  ...
                  <div style={{ fontSize: 12, color: "#787486" }}>
                    {candidate.updatedAt
                      ? formatDateToRelativeTime(new Date(candidate.updatedAt))
                      : "N/A"}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            {pendingAIInterviewReview?.length > 0 && (
              <button
                ...
                onClick={() =>
                  (window.location.href = "/recruiter-dashboard/to-do?tab=interview-review")
                }
              >
                View All
              </button>
            ...
            <div className="pending-recruiter-task-table">
              ...
              {pendingAIInterviewReview.slice(0, 10).map((candidate, index) => (
                <div
                  ...
                  style={{
                    borderBottom:
                      index === pendingAIInterviewReview.slice(0, 10).length - 1
                        ? "none"
                        : "1px solid #E0E0E0",
                  }}
                >
              ...
              <button
                ...
                onClick={() =>
                  (window.location.href =
                    "/recruiter-dashboard/to-do?tab=retake-interview-requests")
                }
              >
                View All
              </button>
            ...
            <div className="pending-recruiter-task-table">
              ...
              {pendingRetakeRequest.slice(0, 10).map((candidate, index) => (
                <div
                  ...
                  style={{
                    borderBottom:
                      index === pendingRetakeRequest.slice(0, 10).length - 1
                        ? "none"
                        : "1px solid #E0E0E0",
                  }}
                >
