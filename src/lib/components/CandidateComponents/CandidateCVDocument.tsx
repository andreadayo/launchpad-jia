      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.avatarRow}>
            {candidate?.image && <Image src={candidate.image} style={styles.avatar} />}
            <View>
        ...
        <View style={styles.introSection}>
          ...
          <Text>
            {getSection("Introduction") || (
              <Text style={styles.noContent}>No introduction provided in CV</Text>
            )}
          </Text>
        </View>
        ...
        <View style={styles.sectionRow}>
          ...
          <View style={styles.leftCol}>
            ...
            <View style={styles.section}>
              ...
              <Text>
                {getSection("Current Position") || (
                  <Text style={styles.noContent}>No current position provided in CV</Text>
                )}
              </Text>
            </View>
          ...
          <View style={styles.rightCol}>
            ...
            <View style={styles.section}>
              ...
              <Text>
                {getSection("Projects") || (
                  <Text style={styles.noContent}>No projects provided in CV</Text>
                )}
              </Text>
            </View>
            <View style={styles.divider} />
