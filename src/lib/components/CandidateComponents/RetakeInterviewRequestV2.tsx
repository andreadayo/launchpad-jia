    ...
    <div className="layered-card-middle" style={{ backgroundColor: "#181D27" }}>
      ...
      <div className="layered-card-content">
        <span style={{ fontSize: 16, color: "#181D27", fontWeight: 700 }}>
          The candidate has requested a retake of the interview.
        </span>
        <span>
          Reason:{" "}
          {interviewDetails?.retakeRequest?.reason ||
            interviewDetails?.retakeRequest ||
            "No reason provided"}
        </span>
        <span>
          Request submitted on:{" "}
          {moment(interviewDetails?.retakeRequest?.createdAt).format("MMM D, YYYY | hh:mm:ss A")}
        </span>
