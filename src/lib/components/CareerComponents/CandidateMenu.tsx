  ...
  return (
    <div className="candidate-side-menu">
      <div className="candidate-side-menu-content">
        ...
        >
          <div onClick={() => setCandidateDetailsOpen(true)} className="candidate-info-section">
            <img
              alt={candidate?.name}
              src={candidate?.image}
        ...
        {isAIInterviewAnalysisOpen && (
          <div>
            ...
            {!summary && !analysis && !isGeneratingSummary && !isGeneratingAnalysis && (
              ...
              >
                <p style={{ fontSize: 16, color: "#717680", fontWeight: 500 }}>
                  Candidate has not taken AI Interview. <br /> Analysis unavailable.
                </p>
              </div>
            )}
          </div>
      ...
      {candidateDetailsOpen && (
        <CandidateModal candidate={candidate} setShowCandidateModal={setCandidateDetailsOpen} />
      )}
    </div>
  );
}
