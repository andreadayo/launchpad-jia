        ...
        >
          <div className="modal-header">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <button
                ...
                onClick={() => setShowCandidateCV(false)}
              >
          ...
          {isLoading ? (
            ...
            <div className="modal-body">
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                  <div>
                    ...
                    ></i>
                    JIA thinks this candidate is a{" "}
                    {
                      <CareerFit
                        fit={
              ...
              <div
                style={{ display: "flex", alignItems: "flex-start", flexDirection: "row", gap: 16 }}
              >
                <div
                  style={{
                    width: "60%",
                ...
                >
                  <div>
                    ...
                    <Markdown>
                      {getContent("Current Position") || "No current position provided in CV"}
                    </Markdown>
                  </div>
                  <div
                    style={{
                  ...
                  <div>
                    <h3>Experience</h3>
                    <Markdown>
                      {getContent("Experience") || "No experience provided in CV"}
                    </Markdown>
                  </div>
                  <div
                    style={{
                ...
                <div style={{ width: "40%", display: "flex", flexDirection: "column" }}>
                  <div>
                    ...
                    <Markdown>
                      {getContent("Contact Info") || "No contact information provided in CV"}
                    </Markdown>
                  </div>
                  <div
                    style={{
                  ...
                  <div>
                    ...
                    <Markdown>
                      {getContent("Certifications") || "No certifications provided in CV"}
                    </Markdown>
                  </div>
                  <div
                    style={{
