...
export default function InterviewQuestionModal({
  ...
  groupId: number;
  questionToEdit?: { id: number; question: string };
  action: string;
  onAction: (action: string, groupId?: number, question?: string, questionId?: number) => void;
}) {
      ...
      >
        ...
        >
          ...
          >
            ...
            {action === "delete" ? (
              <p style={{ maxWidth: "352px" }}>{actions[action]?.subtext}</p>
            ) : (
              <textarea
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  gap: 8,
                  backgroundColor:
                    !question?.trim() && action !== "delete" ? "#D5D7DA" : actions[action]?.color,
                  color: "#FFFFFF",
                  borderRadius: "60px",
                  border: "1px solid #D5D7DA",
                  cursor: "pointer",
